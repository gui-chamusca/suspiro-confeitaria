...
Produtos: fatia_bolo, fatia_torta_doce, fatia_torta_salgada, torta_inteira, pao_mel, sanduiche, salada, outro (bolo por encomenda NÃO entra aqui — só em encomendas.json)
